# Visual system — landing-page-design

The non-negotiable visual values for `landing-page-design`. Every visual value must
resolve through these rules instead of being invented ad hoc. Section numbers (B1–B11)
are referenced by name from `SKILL.md`.
