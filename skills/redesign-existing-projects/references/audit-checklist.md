...
The diagnostic pass for `redesign-existing-projects`. Each section names what to look
for in an existing interface. Concrete replacement values live in `design-values.md`.
